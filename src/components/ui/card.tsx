...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={`rounded-2xl border border-gray-200/60 bg-white/80 backdrop-blur-sm text-gray-900 shadow-lg hover:shadow-xl transition-all duration-300 ${className || ''}`}
    {...props}
  />
));
